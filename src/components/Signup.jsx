...
export default function Signup() {
  ...
  const [passwordVisiblity, setPasswordVisibility] = useState(
    "bx bx-hide show-hide"
  );
  const [confirmPasswordVisiblity, setConfirmPasswordVisibility] = useState(
    "bx bx-hide show-hide"
  );
  ...
  function handleSubmit(e) {
    ...
    if (
      ...
      axios
        .post("http://localhost:5108/api/User/RegisterUser", addUser)
        ...
        <form action="" className="form">
          <div className="field">
            ...
            <span className={errorFirstName}>
              ...
              <p className="error-text">
                First name only be capital letter, small letter and white space
              </p>
            </span>
          </div>
          <div className="field">
            ...
            <span className={errorLastName}>
              <i className="bx bx-error-circle error-icon"></i>
              <p className="error-text">
                last name only be capital letter, small letter and white space
              </p>
            </span>
          </div>
          <div className="field">
          ...
          <div className="field">
            <div className="password-input-field">
              ...
              />
              <i
                className={confirmPasswordVisiblity}
                onClick={() => {
